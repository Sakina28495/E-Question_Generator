...
(b+=10);return b<20?0:b<30?1:b<40?2:3};c.fn.pwstrength=function(a){a=c.extend({label:".label",classes:["pw-weak","pw-medium","pw-fair","pw-strong"],texts:["Weak","Medium","Fair","Strong"]},a||{});a.indicator=c("#"+this.data("indicator"));return this.keyup(a,g)}})(jQuery);
