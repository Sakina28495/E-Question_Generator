...
style.type = 'text/css';
style.innerHTML = '.error {border-color:red !important;background:url(images/icons/fail.png)!important;background-repeat: no-repeat !important;background-position:right 20px center !important;background-size: 15px 15px !important;  color:#000 !important;}.success {background:url(images/icons/success.png)!important;background-repeat: no-repeat !important;background-position:right 20px center !important;background-size: 15px 15px !important;}';
