	...
	<body class="subpage">
		...
		<!-- Header -->
			<header id="header">
				...
				<a href="index.html">Grow <span> to LEARN</span></a></div>
		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="register1.php">Admin - The Boss </a></li>
...
<img src="images/nature.png" style="position:absolute;top:120px;padding-left:35px;width:1150px;height:420px" alt="">	 
		 ...
		 <form action="signin.php" method="post" class="form login" style="position:relative;padding-top:90px;padding-left:58px">
